...
public class ForecastActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onClick(View view){
        switch(view.getId()){
            ...
            case R.id.tv_about:
                Intent intent = new Intent(ForecastActivity.this,AboutActicity.class);
